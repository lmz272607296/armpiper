...
class HardwarePlayer(object):
    ...
    def fetch_grasp_state(self, s=1.0):
        ...
        package_share_dir = get_package_share_directory('interface')
    ...
    def deploy(self):
        import rclpy
        from interface.hardware_controller import LeapHand
        ...
        data_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "cache", "woven_model_trajectory_1.npy")
