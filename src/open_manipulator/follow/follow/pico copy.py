...
def main():
    ...
    #--------------------------------
    #在这里调控电机数量
    single_indices=np.array([17,18,22])
    ...
    #-------------------------------------------------
        ...
        publish.get_logger().info(f"当前手指角度: {angle_rule[18:]}") 
        ...
        if loop%number==0 and test_mode==False:
            ...
            publish.arm_command_joint_position(track[:,18:],single_indices,speed)
